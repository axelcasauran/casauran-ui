...
F0.18's `documentation/foundation.json` owns the private `apps/docs` shell, presentation
primitives, stage-registry metadata integration, SSR boundary, and deterministic docs-host visual
evidence. It is application infrastructure and does not create a public component or package.
